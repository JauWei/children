...
const Piggy = ({ size = 120, fill = 0.5 }) => {
  ...
  return (
    <svg viewBox="0 0 120 100" width={size} height={(size * 100) / 120} style={{ display: "block" }}>
      ...
      {/* fill liquid (visible through transparent body) */}
      <defs>
...
/* ============================================================
   Illustration Placeholder — replace with real art later
   Usage: <Illus name="ch1-barter" desc="兔兔和小羊以物易物" icon="🥕↔️🧀"/>
   To replace: drop a file at assets/illus/<name>.png (or .jpg/.svg)
   and the placeholder will auto-show the image instead of the dashed box.
   ============================================================ */
